...
class OAuthClient {
  ...
  // PENDING - server-side support to manage tokens

  // set cookies for access token
  /**
   * stores the access token in a cookie (server-side usage)
   * @param {string} accessToken
   */

  // jwt - claim, hash, signature (for access token)

  // sleep before handleCallback
}
